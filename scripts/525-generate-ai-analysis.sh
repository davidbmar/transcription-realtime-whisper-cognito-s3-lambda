...
if [ $# -eq 0 ]; then
    ...
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "How to get session details:"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "  1. Open Transcript Editor: https://d2l28rla2hk7np.cloudfront.net/transcript-editor-v2.html"
    echo "  2. Click 'ℹ️  Session Info' button in the Actions section"
    echo "  3. Copy the 'Session ID' and 'User ID' values"
    echo "  4. Build the session path: users/<USER_ID>/audio/sessions/<SESSION_ID>"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "Examples:"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "  # Analyze a specific session:"
    echo "  $0 --session-path users/abc123-def-456/audio/sessions/session_2025-11-24T10_30_00_000Z"
    echo ""
    echo "  # Re-analyze (force overwrite existing analysis):"
    echo "  $0 --session-path users/abc123-def-456/audio/sessions/session_2025-11-24T10_30_00_000Z --force"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "Batch operations:"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "  # Analyze all sessions (interactive):"
    echo "  ./scripts/527-find-session-path.sh --all-analyze"
    echo ""
    echo "  # Search and analyze specific sessions:"
    echo "  ./scripts/527-find-session-path.sh upload          # Filter by 'upload'"
    echo "  ./scripts/527-find-session-path.sh 20251124        # Filter by date"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    exit 1
